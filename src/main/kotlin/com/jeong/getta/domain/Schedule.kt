...
data class Schedule(
    ...
    @Schema(description = "출발 시간", nullable = false, example = "2023-11-08T10:25:20.254Z")
    val departTime: LocalDateTime,
    @Schema(description = "도착 시간", nullable = false, example = "2023-11-08T11:25:20.254Z")
    val arriveTime: LocalDateTime,
    @Schema(description = "소요 시간", nullable = false, example = "60")
